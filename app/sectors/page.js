...
Our approach includes studying comparative religion not to diminish other faiths, but to understand different perspectives and find common ground for meaningful conversation. We prepare students to defend Islamic principles intellectually while maintaining the prophetic character of gentleness and respect in all interactions.`,
  ...
  },
  {
    ...
    subtitle: 'Student Welfare & Leadership Development',
    description: 'Comprehensive support system ensuring the holistic wellbeing and development of all students.',
    icon: Shield,
    color: 'purple',
    detailedDescription: `The Ziyara sector serves as the protective and nurturing arm of HUMSJ, ensuring that every student receives the support they need to thrive academically, spiritually, and personally. Ziyara, meaning "visit" or "care," embodies our commitment to knowing and caring for each individual student.

This sector provides comprehensive welfare services including academic support, mental health resources, spiritual counseling, and practical assistance. We recognize that students face diverse challenges and our role is to provide a safety net that enables success while maintaining Islamic values and community bonds.

The sector also focuses on developing student leadership capabilities, identifying and nurturing future leaders who will serve the Muslim community. Through mentorship programs, leadership training, and practical experience opportunities, students develop the skills and confidence needed for effective community service.`,
    tracks: [
      {
        name: 'Welfare Dashboard',
        description: 'Comprehensive student support and tracking system',
        features: ['Student Tracking', 'Wellbeing Assessment', 'Support Coordination', 'Progress Monitoring']
      },
      {
