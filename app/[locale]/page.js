        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
              <p className="font-quran text-lg sm:text-xl md:text-2xl text-white">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-6 justify-start md:justify-end">
        ...
        <div className="relative container mx-auto px-6">
          <div className="text-center max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              <Link
                href="/auth/signup"
                className="group inline-flex w-full sm:w-auto justify-center items-center gap-3 px-6 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-emerald-500 dark:to-teal-500 text-white hover:from-emerald-700 hover:to-teal-700 dark:hover:from-emerald-600 dark:hover:to-teal-600 rounded-2xl font-bold text-base sm:text-xl transition-all shadow-xl hover:shadow-2xl transform hover:-translate-y-1"
              >
              ...
              <Link
                href="/sectors"
                className="inline-flex w-full sm:w-auto justify-center items-center gap-3 px-6 sm:px-10 py-4 sm:py-5 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-2 border-slate-200 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-700 hover:border-emerald-300 dark:hover:border-emerald-500 hover:text-emerald-700 dark:hover:text-emerald-400 rounded-2xl font-bold text-base sm:text-xl transition-all shadow-lg hover:shadow-xl"
              >
              ...
              <Link
                href="/auth/login"
                className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4 text-slate-600 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 font-semibold text-base sm:text-lg transition-colors"
              >
            ...
            {/* Quranic Inspiration */}
            <div className="bg-gradient-to-r from-emerald-500/10 via-teal-500/10 to-blue-500/10 rounded-3xl p-6 sm:p-10 lg:p-12 border-2 border-emerald-300/50 backdrop-blur-sm shadow-xl">
              <div className="max-w-4xl mx-auto text-center space-y-6">
                ...
                <p className="quran-verse text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-emerald-800">
                  ٱدۡعُ إِلَىٰ سَبِيلِ رَبِّكَ بِٱلۡحِكۡمَةِ وَٱلۡمَوۡعِظَةِ ٱلۡحَسَنَةِۖ
                </p>
                <div className="verse-divider text-emerald-400"></div>
                <p className="quran-translation text-base sm:text-xl md:text-2xl text-slate-700 dark:text-slate-300">
      ...
      <section className="py-20 bg-white dark:bg-slate-900 transition-colors">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-slate-100 mb-6">
              Our Dawah & Irshad Services
            </h2>
            <p className="text-lg sm:text-2xl text-slate-600 dark:text-slate-400 max-w-4xl mx-auto">
                ...
                >
                  <div className={`p-10 rounded-3xl transition-all duration-500 ${
                    ...
                    <div className="flex flex-col sm:flex-row items-start gap-6 sm:gap-8 mb-8">
                      <div className={`w-14 h-14 sm:w-20 sm:h-20 bg-gradient-to-br ${colorClasses[feature.color]} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform`}>
                        <Icon className="w-7 h-7 sm:w-10 sm:h-10 text-white" />
                      </div>
                      <div className="flex-1">
                        <h3 className="text-xl sm:text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4">{feature.title}</h3>
                        <p className="text-slate-600 dark:text-slate-400 text-base sm:text-lg leading-relaxed mb-4">{feature.description}</p>
                        <div className="text-emerald-600 dark:text-emerald-400 font-semibold text-base sm:text-lg">{feature.stats}</div>
                      </div>
                    </div>
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-600 via-teal-600 to-blue-600 islamic-gradient-dark text-white">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl sm:text-5xl lg:text-7xl font-bold mb-8">
              Join the Dawah Mission
            </h2>
            <p className="text-lg sm:text-2xl lg:text-3xl text-emerald-100 dark:text-emerald-200 mb-12 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center items-center mb-16">
              <Link
                href="/auth/signup"
                className="inline-flex w-full sm:w-auto justify-center items-center gap-4 px-6 sm:px-12 py-4 sm:py-6 bg-white text-emerald-600 rounded-2xl font-bold text-base sm:text-2xl hover:bg-emerald-50 dark:hover:bg-slate-100 transition-all shadow-2xl hover:shadow-3xl transform hover:-translate-y-1"
              >
              ...
              <Link
                href="/sectors"
                className="inline-flex w-full sm:w-auto justify-center items-center gap-4 px-6 sm:px-12 py-4 sm:py-6 border-2 border-white text-white rounded-2xl font-bold text-base sm:text-2xl hover:bg-white hover:text-emerald-600 transition-all"
              >
            ...
            <div className="bg-white/10 dark:bg-white/5 rounded-3xl p-6 sm:p-10 lg:p-12 backdrop-blur-sm border-2 border-white/30 dark:border-white/20 shadow-2xl">
              <div className="max-w-4xl mx-auto text-center space-y-6">
                <div className="mb-4">
                ...
                <p className="quran-verse text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-white">
                  وَمَنۡ أَحۡسَنُ قَوۡلٗا مِّمَّن دَعَآ إِلَى ٱللَّهِ
                </p>
                <div className="verse-divider text-white/50"></div>
                <p className="quran-translation text-base sm:text-xl md:text-2xl text-emerald-50 dark:text-emerald-100">
