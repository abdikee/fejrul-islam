...
import { 
  ...
  Filter, Search, Grid, List, Trophy, Target
} from 'lucide-react';
              ...
              <div key={course.id} className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200 hover:shadow-xl transition-all">
                ...
                <div className="mb-4">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm text-slate-600">{course.progress_percentage || 0}%</span>
                  </div>
                ...
                <div className="flex items-center justify-between text-sm text-slate-600 mb-4">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span>{course.related_resources || 0} resources</span>
                  </div>
                </div>
...
export default function StudentCourses() {
  return (
    <DashboardPageLayout 
      title="My Courses" 
      subtitle="Manage your Islamic learning journey"
    >
      <CoursesContent />
    </DashboardPageLayout>
  );
