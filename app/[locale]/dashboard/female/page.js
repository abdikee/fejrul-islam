...
export default function FemaleDashboard() {
  ...
  useEffect(() => {
    // Check for enrollment success parameter
    const urlParams = new URLSearchParams(window.location.search);
    const enrolledSector = urlParams.get('enrolled');
    if (enrolledSector) {
      setEnrollmentSuccess(enrolledSector);
      // Clean up URL
    ...
    // Fetch current user data + dashboard data
        ...
        <div className="container mx-auto px-4 lg:px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full flex items-center justify-center p-2 bg-white shadow-md">
                <img 
                  src="/logo.svg" 
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-green-700 text-sm">
                  You have been enrolled in <strong>{enrollmentSuccess.replace(/-/g, ' ').replace(/\b\w/g, l => l.toUpperCase())}</strong>. 
                  Check your courses below or visit the sectors page to access materials.
                </p>
              </div>
              <button 
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-teal-200">
              <div className="flex items-center justify-between gap-4 mb-4">
                <div>
                  ...
                  <p className="text-sm text-slate-600">Unenrolled courses you can start now</p>
                </div>
                <Link
                  href="/dashboard/courses"
              ...
              {availableCourses.length === 0 ? (
                <div className="text-sm text-slate-600">No available courses right now.</div>
              ) : (
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="min-w-0">
                          <div className="text-xs text-slate-500 mb-1">
                            {course.sector_name || 'General'} • {course.level || 'Beginner'}
                          </div>
                        ...
                        <button
                          ...
                          className="shrink-0 px-3 py-2 text-sm font-semibold bg-teal-600 hover:bg-teal-700 text-white rounded-lg"
                        >
                          Enroll
                        </button>
                      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-purple-500 to-rose-500 rounded-2xl p-6 text-white">
              <div className="text-center">
                ...
                <p className="text-sm text-purple-100 mb-3 font-quran">
