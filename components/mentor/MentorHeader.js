...
export default function MentorHeader({ user }) {
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden lg:flex items-center gap-3 mr-4">
                <div className="flex items-center gap-2 px-3 py-1 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <span className="text-sm font-medium text-green-700">{user?.totalStudents || 12} Students</span>
                </div>
                <div className="flex items-center gap-2 px-3 py-1 bg-orange-50 rounded-lg border border-orange-200">
                  <FileCheck className="w-4 h-4 text-orange-600" />
                  <span className="text-sm font-medium text-orange-700">{user?.pendingReviews || 5} Reviews</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 pl-3 border-l border-slate-200">
                ...
                <div className="hidden md:block">
                  ...
                  <p className="text-xs text-slate-500">{user?.level || 'Mentor'}</p>
                </div>
                <button 
